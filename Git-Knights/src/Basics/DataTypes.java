...
public class DataTypes {
	...
	public static void main(String[] args) {
		...
		long distance2=-92233_72036854775808l;//size is 64 bit
		
		int weight=2_147_483_647;//32 bit
		int weight2=-2_147_483_648;//32 bit
		...
		String str="Hello and Welcome to Java";// the size is unlimited - it can contain a stream of characters either a word or a
		                                        //sentence or a para or essay etc
